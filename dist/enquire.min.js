...
window.enquire=function(a){function b(a,b){var c=0,d=a.length,e;for(c;c<d;c++){e=b(a[c],c);if(e===!1)break}}function c(a){return Object.prototype.toString.apply(a)==="[object Array]"}function d(a){this.initialised=!1,this.onMatch=a.match,this.onUnmatch=a.unmatch,this.onSetup=a.setup,a.deferSetup||this.setup()}function e(a){this.query=a,this.handlers=[],this.matched=this.matchMedia()}function f(){if(!a)throw new Error("matchMedia is required for media query dispatcher");this.queries=[],this.listening=!1}return"use strict",d.prototype={setup:function(){this.onSetup&&this.onSetup(),this.initialised=!0},on:function(a){this.initialised||this.setup(),this.onMatch(a)},off:function(a){this.onUnmatch&&this.onUnmatch(a)}},e.prototype={matchMedia:function(){return a(this.query).matches},addHandler:function(a){var b=new d(a);this.handlers.push(b),this.matched&&b.on()},match:function(a){if(this.matched)return;b(this.handlers,function(b){b.on(a)}),this.matched=!0},unmatch:function(a){if(!this.matched)return;b(this.handlers,function(b){b.off&&b.off(a)}),this.matched=!1}},f.prototype={register:function(a,d){var f=this.queries,g;return f.hasOwnProperty(a)||(f[a]=new e(a)),g=f[a],c(d)||(d=[d]),b(d,function(a){g.addHandler(a)}),this},fire:function(a){var b=this.queries,c;for(c in b){if(!b.hasOwnProperty(c))continue;var d=b[c];d.matchMedia()?d.match(a):d.unmatch(a)}return this},listen:function(a){function d(d){var e;b(d,function(b){e&&clearTimeout(e),e=setTimeout(function(){c.fire(b)},a)})}var b=window.addEventListener||window.attachEvent,c=this;return a=a||500,this.listening?this:(c.fire(),d("resize"),d("orientationChange"),this.listening=!0,this)}},new f}(window.matchMedia);